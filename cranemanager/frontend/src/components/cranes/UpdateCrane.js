                ...
                <Form>
                    <Form.Group controlId="contentId">
                        ...
                        {/* <Form.Control
                            ...
                            rows={3}
                            name="craneType"
                            placeholder={this.craneType}
                            value={this.craneType}
                            onChange={this.onChange}
                        /> */}

                        {this.props.cranes.map(cranes => (
                            <Form.Group key={cranes.id} className="mb-3" controlId="formBasicEmail">
                                <Form.Label>Email address</Form.Label>
                                <Form.Control type="text" value={this.craneType} placeholder={cranes.craneType} />
...
export default connect(mapStateToProps, { getCranes, updateCranes, getExamination })(withRouter(UpdateCrane));