    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personResponsibleForSupervision', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cranes', to='cranes.personresponsibleforsupervision')),
                ('personResponsibleToFixedState', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cranes', to='cranes.personresponsibletofixedstate')),
